...
class TestAutomationServiceCrear:
    ...
    def test_crear_automatizacion_exitosa(
        self, mock_automation_service, mock_automation_dao, mock_home_dao, home_test
    ):
    ...
    def test_crear_automatizacion_nombre_vacio(
        self, mock_automation_service, mock_home_dao
    ):
        ...
        # Act
        exito, mensaje = mock_automation_service.crear_automatizacion(
            nombre="", descripcion="Test", home_id=1
        )
    ...
    def test_crear_automatizacion_descripcion_vacia(
        self, mock_automation_service, mock_home_dao
    ):
        ...
        # Act
        exito, mensaje = mock_automation_service.crear_automatizacion(
            nombre="Test", descripcion="", home_id=1
        )
    ...
    def test_crear_automatizacion_hogar_no_encontrado(
        self, mock_automation_service, mock_home_dao
    ):
        ...
        # Act
        exito, mensaje = mock_automation_service.crear_automatizacion(
            nombre="Test", descripcion="Test description", home_id=999
        )
    ...
    def test_crear_automatizacion_error_insercion(
        self, mock_automation_service, mock_automation_dao, mock_home_dao, home_test
    ):
        ...
        # Act
        exito, mensaje = mock_automation_service.crear_automatizacion(
            nombre="Test", descripcion="Test description", home_id=1
        )
    ...
    def test_crear_automatizacion_inactiva_por_defecto(
        self, mock_automation_service, mock_automation_dao, mock_home_dao, home_test
    ):
        ...
        # Act
        exito, mensaje = mock_automation_service.crear_automatizacion(
            nombre="Test", descripcion="Test description", home_id=1, activar=False
        )
...
class TestAutomationServiceListar:
    ...
    def test_listar_todas_las_automatizaciones(
    ...
    def test_listar_automatizaciones_vacio(
    ...
    def test_obtener_automatizacion_por_id(
        self, mock_automation_service, mock_automation_dao, automatizacion_test
    ):
    ...
    def test_obtener_automatizacion_no_encontrada(
        self, mock_automation_service, mock_automation_dao
    ):
    ...
    def test_obtener_automatizaciones_por_hogar(
        self, mock_automation_service, mock_automation_dao, automatizacion_test
    ):
    ...
    def test_obtener_automatizaciones_activas(
        self, mock_automation_service, mock_automation_dao, automatizacion_test
    ):
    ...
    def test_obtener_automatizaciones_usuario(
        self,
        ...
        # Act
        resultado = mock_automation_service.obtener_automatizaciones_usuario(
            "user@test.com"
        )
...
class TestAutomationServiceActualizar:
    ...
    def test_actualizar_nombre_exitoso(
        ...
        exito, mensaje = mock_automation_service.actualizar_automatizacion(
            automation_id=1, nuevo_nombre="Modo Nocturno Mejorado"
        )
    ...
    def test_actualizar_descripcion_exitoso(
        self, mock_automation_service, mock_automation_dao, automatizacion_test
    ):
        ...
        # Act
        exito, mensaje = mock_automation_service.actualizar_automatizacion(
            automation_id=1, nueva_descripcion="Nueva descripción"
        )
    ...
    def test_actualizar_nombre_y_descripcion(
        self, mock_automation_service, mock_automation_dao, automatizacion_test
    ):
    ...
    def test_actualizar_automatizacion_no_encontrada(
        self, mock_automation_service, mock_automation_dao
    ):
        ...
        # Act
        exito, mensaje = mock_automation_service.actualizar_automatizacion(
            automation_id=999, nuevo_nombre="Test"
        )
    ...
    def test_actualizar_sin_cambios(
        ...
        assert exito is False
        assert (
            "no hay cambios" in mensaje.lower()
            or "al menos un campo" in mensaje.lower()
        )
    ...
    def test_actualizar_error_modificacion(
        ...
        # Act
        exito, mensaje = mock_automation_service.actualizar_automatizacion(
            automation_id=1, nuevo_nombre="Test"
        )
...
class TestAutomationServiceEliminar:
    ...
    def test_eliminar_automatizacion_exitosa(
        self, mock_automation_service, mock_automation_dao, automatizacion_test
    ):
    ...
    def test_eliminar_automatizacion_no_encontrada(
        self, mock_automation_service, mock_automation_dao
    ):
    ...
    def test_eliminar_automatizacion_error_bd(
        self, mock_automation_service, mock_automation_dao, automatizacion_test
    ):
...
class TestAutomationServiceEstado:
    ...
    def test_activar_automatizacion_exitosa(
        self, mock_automation_service, mock_automation_dao, automatizacion_test
    ):
    ...
    def test_activar_automatizacion_ya_activa(
        self, mock_automation_service, mock_automation_dao, automatizacion_test
    ):
    ...
    def test_desactivar_automatizacion_ya_inactiva(
        self, mock_automation_service, mock_automation_dao, automatizacion_test
    ):
...
class TestAutomationServiceResumen:
    ...
    def test_obtener_resumen_automatizaciones(
        self,
        mock_automation_service,
        mock_automation_dao,
        automatizacion_test,
